...
for c in cnts:
    ...
    if area > min_area and area < max_area:            #hadi dertha ghir 3la 9bel answers walakine daba useless 7it zedtha fel fonction lte7t
...
for c in reversed(cnts):
    ...
    if area > min_area and area < max_area:
        ...
        # n9elbo 3la l countours o ndiro lhook dial thresh
...
#arrc list li kan7eto fih l asnwers dial lwer9a
arrc = []
